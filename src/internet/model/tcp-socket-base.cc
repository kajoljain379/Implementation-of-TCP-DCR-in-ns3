...
{
  NS_LOG_FUNCTION (this);
  std::cout<<"DCR after coming to socket listen is="<<m_dcrEnabled<<std::endl;  
...
{
  NS_LOG_FUNCTION (this);
  std::cout<<"DCR2="<<m_dcrEnabled<<std::endl;  
 // std::cout<<"win="<<Window()<<std::endl;
  ...
  if (m_tcb->m_congState == TcpSocketState::CA_OPEN)
    {
      ...
      if(m_dcrEnabled)
       {
         SetRetxThresh(3);
         std::cout<<"retx="<<m_retxThresh<<std::endl;
         m_dcrRetxThresh =  m_retxThresh+((Window () * (m_rtt->GetEstimate ().GetMilliSeconds () * 1.0 / m_instRtt.GetMilliSeconds ()))/m_tcb->m_segmentSize);
       // m_dcrRetxThresh = m_retxThresh+(m_rtt->GetEstimate ().GetMilliSeconds () * 1.0 / m_instRtt.GetMilliSeconds ());
         std::cout<<"win="<<Window()<<std::endl;
         std::cout<<"getm="<<m_rtt->GetEstimate ().GetMilliSeconds ();
         std::cout<<"instrtt="<<1.0 / m_instRtt.GetMilliSeconds ()<<std::endl;
         std::cout<<"m_dcrthresh="<<m_dcrRetxThresh<<std::endl;
         SetRetxThresh(m_dcrRetxThresh);
         std::cout<<"retx after setting ="<<m_retxThresh<<std::endl;
       }
    }
...
{
  //std::cout<<"get in processAck phase\n";
...
std::cout<<"isDupack value is"<<isDupack<<"\n";
////
//isDupack=true;
...
TcpSocketBase::ReTxTimeout ()
{
  ...
  std::cout<<"Resetsack value is"<<resetSack<<"\n";
  // Reset dupAckCount
  m_dupAckCount = 0;
  if (!m_sackEnabled)
    {
